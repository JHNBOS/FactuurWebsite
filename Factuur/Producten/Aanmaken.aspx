        ...
        <div class="col-sm-10">
            ...
            <asp:Table ID="CreateTable" runat="server" GridLines="None" CssClass="table table-hover">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell><asp:TextBox ID="prijsBox" runat="server" CssClass="form-control" />
                        <asp:RegularExpressionValidator ID="NumericOnlyValidator" runat="server" ControlToValidate="prijsBox" ErrorMessage="Voer een juist getal in." ValidationExpression="((\d+)((\,\d{1,2})?))$" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
